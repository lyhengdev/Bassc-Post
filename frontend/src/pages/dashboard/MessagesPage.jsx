    ...
    <>
      ...
      {messages.length > 0 ? (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Messages List */}
          <div className={`lg:col-span-1 space-y-3 ${selectedMessage ? 'hidden lg:block' : 'block'}`}>
              ...
              <div className="card p-4 sm:p-6">
                <div className="flex items-center justify-between mb-4 lg:hidden">
                  <button
                    ...
                    className="text-sm text-dark-500 hover:text-dark-900 dark:hover:text-white"
                  >
                    ← Back to list
                  </button>
                </div>
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-semibold text-dark-900 dark:text-white mb-1">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  >
                    {selectedMessage.status === 'replied' ? 'Reply Again' : 'Send Reply'}
                  </Button>
                  <Button
                    variant="danger"
                    leftIcon={<Trash2 className="w-4 h-4" />}
                    onClick={() => setDeleteModal({ id: selectedMessage._id, name: selectedMessage.name })}
                  >
                    Delete
                  </Button>
                </div>
