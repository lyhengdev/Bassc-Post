...
export function ArticleInsightsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>News Insights - Bassac Media Center</title>
      </Helmet>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-dark-900 dark:text-white">News Insights</h1>
            <p className="text-sm text-dark-500">{article?.title || 'News performance'}</p>
          </div>
        </div>
      ...
      {!isLoading && (
        <div className="space-y-6">
          ...
          <div className="card p-6">
            <h2 className="text-lg font-semibold text-dark-900 dark:text-white mb-4">News Details</h2>
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                <thead className="text-left text-dark-500">
                  <tr>
