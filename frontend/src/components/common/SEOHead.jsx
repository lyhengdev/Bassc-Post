...
/**
 * SEO Head Component for News Articles
...
/**
 * Article SEO wrapper - simplified API for articles
 */
...
/**
 * Page SEO wrapper - for static pages
 */
export function PageSEO({ page, siteSettings }) {
  if (!page) return null;
