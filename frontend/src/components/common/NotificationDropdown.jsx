        ...
        <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white dark:bg-dark-900 rounded-xl shadow-xl border border-dark-200 dark:border-dark-700 overflow-hidden z-50">
          ...
          {notifications.length > 0 && (
            <Link
              ...
              className="flex items-center justify-center gap-1 px-4 py-3 text-sm text-primary-600 hover:bg-primary-50 dark:hover:bg-primary-950/20 border-t border-dark-200 dark:border-dark-700 transition-colors"
            >
