...
export const articlesAPI = {
  ...
  getEditorWorkflowQueue: (params) => api.get('/articles/workflow/editor-queue', { params }),
  getTranslatorWorkflowQueue: (params) => api.get('/articles/workflow/translator-queue', { params }),
  getAdminWorkflowQueue: (params) => api.get('/articles/workflow/admin-queue', { params }),
  sourceSubmitWorkflow: (id) => api.post(`/articles/${id}/workflow/source-submit`),
  approveSourceWorkflow: (id, payload = {}) => api.put(`/articles/${id}/workflow/source-approve`, payload),
  requestSourceChangesWorkflow: (id, payload = {}) => api.put(`/articles/${id}/workflow/source-request-changes`, payload),
  submitTranslationWorkflow: (id, payload = {}) => api.post(`/articles/${id}/workflow/translation-submit`, payload),
  approveTranslationWorkflow: (id, payload = {}) => api.put(`/articles/${id}/workflow/translation-approve`, payload),
  requestTranslationChangesWorkflow: (id, payload = {}) => api.put(`/articles/${id}/workflow/translation-request-changes`, payload),
  finalApproveWorkflow: (id, payload = {}) => api.put(`/articles/${id}/workflow/final-approve`, payload),
  finalRejectWorkflow: (id, payload = {}) => api.put(`/articles/${id}/workflow/final-reject`, payload),
